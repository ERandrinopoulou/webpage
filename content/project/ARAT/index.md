...
A interactive interface is created so that the treated physician can obtain dynamice predictions (https://emcbiostatistics.shinyapps.io/DynamicPredictionARATapp/). This interactive interface is based on a univariate linear mixed model. Work in progress: extend the app to accommodate multivariate latent class mixed model.
